            ...
            <ScrollView>
                ...
                <View style={{ marginTop: '50%', marginLeft: '90%', paddingBottom: '5%' }}>
                    ...
                    <TouchableOpacity style={styles.camerabtn}>
                        <FontAwesome name="camera" size={20} color="white" style={{ textAlign: 'center', marginVertical: '30%' }} onPress={openCamera} />
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
    ...
    return (
        <Tab.Navigator
            ...
            <Tab.Screen options={{
                tabBarIcon: ({ focused }) => (
                    <TouchableOpacity>
                        <FontAwesome name="camera" size={19} color="#cadcda" />
                    </TouchableOpacity>
                ), tabBarIconStyle: { width: 70 }, tabBarIndicatorStyle: { width: 50, backgroundColor: 'white' }, tabBarShowLabel: false,
            }} name="Camera" component={CameraComponent} />
            <Tab.Screen options={{ tabBarLabel: 'CHATS'}} name="ChatScreen" component={ChatScreen} />
            <Tab.Screen options={{ tabBarLabel: 'STATUS' }} name="StatusScreen" component={StatusScreen} />
            <Tab.Screen options={{ tabBarLabel: 'CALLS' }} name="CallScreen" component={CallScreen} />
        </Tab.Navigator>
