...
import curved14 from '../SignUp/curved14.jpg'
                            ...
                            <div className="card z-index-0">
                                ...
                                <div className="card-body">
                                    <form role="form text-left">
                                        <div className="mb-3">
                                            <input type="text" className="form-control" placeholder="User Name" aria-label="User Name" id="name" />
                                        </div>
                                        <div className="mb-3">
                                            <input type="email" className="form-control" placeholder="Email" aria-label="Email" id="email" />
                                        </div>
                                        <div className="mb-3">
                                            <input type="email" className="form-control" placeholder="Phone" aria-label="Phone" id="phone" />
                                        </div>
                                        <div className="mb-3">
                                            <input type="email" className="form-control" placeholder="Country" aria-label="Country" id="country" />
                                        </div>
                                        <div className="mb-3">
                                            <input type="email" className="form-control" placeholder="City" aria-label="City" id="city" />
                                        </div>
                                        <div className="mb-3">
                                            <input type="password" className="form-control" placeholder="Password" aria-label="Password" id="pass" />
                                        </div>
                                        <div className="text-center">
                                        <Link to="/" style={{ color: 'white' }}><button type="button" className="btn bg-gradient-dark w-100 my-4
                          mb-2">Sign Up</button></Link>
                                        </div>
                                        <p className="text-sm mt-3 mb-0">Already have an account? <Link to="/" className="text-dark
                          font-weight-bolder"> Log In</Link></p>
                                    </form>
                                </div>
                            </div>
                        </div>
